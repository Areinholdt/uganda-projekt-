...
order <- c("Rmv", "Nig", "xxx","Des" ,"Gha", "Ken", "Uga", "Ugw", "Tan", "Zam", "Zim", "Nam")
ggplot(rohan4, aes(x = factor(pop, levels = order), Segments_in_ROH, color = pop)) +
  geom_boxplot() +
  theme_classic()
...
ggplot(rohan4, aes(x = factor(pop, levels = order), Genome.wide_theta_outside_ROH, color = pop)) +
  geom_boxplot() +
  theme_classic()
```
